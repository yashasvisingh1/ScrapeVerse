...
export function Home() {
  ...
  return <div className="app-shell">
    <header className="topbar"><a className="brandmark" href="/"><span className="brandmark-icon" aria-hidden="true">↗</span><span className="brandmark-accent">ONE</span></a><span className="header-note">Live prices, one clear view</span></header>
    <main>
    ...
    <footer><span>ONE</span><span>Prices sourced from Amazon, Myntra &amp; AJIO</span></footer>
  </div>
}
